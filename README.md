<div align="center">
  <img src="./assets/logo.png" alt="Prompt Library Logo" width="280"/>

  # 🧠 The Master Prompt Library
  **An enterprise-grade repository of high-performance prompt engineering templates.**

  [![Status](https://img.shields.io/badge/Status-Active-success.svg)]()
  [![Coverage](https://img.shields.io/badge/Coverage-7_Domains-blue.svg)]()
  [![Structure](https://img.shields.io/badge/Structure-Modular-orange.svg)]()
</div>

---

Welcome to the definitive command center for interacting with Artificial Intelligence. This library eschews generic "copy-paste hacks" in favor of strict, constraint-based frameworks designed to extract maximum value from Large Language Models across multiple professional disciplines.

Everything is organized into highly specialized domains. Dive in below.
...
## 🛠️ How to Use This Architecture

To prevent gigantic, unreadable files, this repository utilizes an **Index/Example** structure.

1.  **Navigate to a Domain:** Click a link in the index above to enter a specific discipline (e.g., *Productivity / Strategy / OKR Goal Setting*).
2.  **The `index.md` File:** Every folder contains an `index.md` file. This houses the actual prompt logic, constraint rules, and variables you need to copy/paste into your AI.
